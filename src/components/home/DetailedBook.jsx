...
export const DetailedBook = ({book, index}) => {
  ...
  return (
    <motion.div variants={childVariants} key={index} className={`flex flex-col sm:flex-row justify-around items-center lg:items-start p-5 gap-3 border rounded-xl transition duration-300 shadow-md glass ${isSelected===index?'bg-primary text-slate-50 hover:text-black':'hover:bg-primary/75 hover:text-slate-50'}`}>

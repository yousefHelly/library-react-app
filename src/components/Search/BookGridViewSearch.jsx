...
export const BookGridViewSearch = ({book,children}) => {
  return (
    <Link className='' to={`/${book.BookId}`}><div className={`bookHolder overflow-hidden relative flex p-3 rounded-xl transition duration-300 flex-col gap-3 cursor-pointer hover:bg-primary hover:text-slate-50`}>

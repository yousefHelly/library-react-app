...
export const Settings = () => {
  ...
  return (
    ...
    <motion.div variants={leftContainerVariants} initial='init' animate='show' className='col-span-2 p-6 glass bg-primary/75 hover:bg-primary/75 rounded rounded-r-none shadow-md flex flex-col gap-8'>
        ...
        {User.type===READER&&<motion.span variants={settingsNavVariants}><NavLink to='account-status' className='text-md flex items-center transition duration-150 hover:text-slate-50 gap-3 p-2 rounded settings-side-sec '><FaUserCog/>Account Status</NavLink></motion.span>}
    </motion.div>
